...
public class CameraScrolling : MonoBehaviour 
{
    ...
    public void SetDistance(float _distance) { distance = _distance; }
    public void SetHeightOffset(float _heightOffset) { heightOffset = _heightOffset; }
    public void SetVelocityLookAhead(float _velocityLookAhead) { velocityLookAhead = _velocityLookAhead; }
    public void SetMaxLookAhead(Vector2 _maxLookAhead) { maxLookAhead = _maxLookAhead; }
    public void SetSpringiness(float _springiness) { springiness = _springiness; }
    public void SetZoomSpeed(float _zoomSpeed) { zoomSpeed = _zoomSpeed; }

    public float GetDistance() { return distance; }
    public float GetHeightOffSet() { return heightOffset; }
    public float GetVelocityLookAhead() { return velocityLookAhead; }
    public Vector2 GetMaxLookAhead() { return maxLookAhead; }
    public float GetSpringiness() { return springiness;  }
    ...
    Vector3 GetGoalPosition() 
    {
        ...
        Vector3 goalPosition = target.position + new Vector3(0, heightOffset, -distance);
